...
public class PengeluaranActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        id = getIntent().getLongExtra(db.id_pengeluaran, 0);
    ...
    private void btn_simpan() {
        ...
        boolean insertPengeluaran = db.tambahPengeluaran(tgl, pnglrn, desc);
        if (insertPengeluaran){
            Toast.makeText(PengeluaranActivity.this, "Data Pengeluaran Tersimpan", Toast.LENGTH_SHORT);
